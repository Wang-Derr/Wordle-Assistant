        ...
        try:
            ...
            while True:
                ...
                if (not all_clear):
                    ...
                    new_indices = input("The index of your letter should be in the range of 1-5, please try again...\n")
                    all_clear = 0
            break
        except ValueError:
            new_indices = input("Your input includes non-integer values, please try again...\n")
    return new_indices
...
def wordEntryHandler(guess):
    ...
    misplaced_indices = input("Please enter the index of misplaced (yellow) letters with no spaces or punctuation between or leave blank if none\n(enter as many time as there are instances e.g. '45' for the 'ff' in 'scoff')\n")
    ...
    correct_indices = input ("Please enter the index of correct (green) letters with no spaces or punctuation between or leave blank if none\n(enter as many time as there are instances e.g. '13' for 'ff' in 'fifth')\n")
...
def subsequentRounds(guess):
    ...
    if (mode):
        ...
        print("This is your current wordbank:\n", dict_list)
        ...
        while True:
            if (wordbank_guess.lower() in dict_list):
                break
            wordbank_guess = input("The word you chose is not a valid guess please try again or leave blank for a random word\n")
            if (len(wordbank_guess) == 0):
                wordbank_guess = random.choice(dict_list)
                break
        ...
        print("This is your randomly suggested word: ", random.choice(dict_list))
        return random_guess
...
print("Please try <", second_guess, "> for your second guess")

# round 3
third_guess = subsequentRounds(second_guess)
print("Please try <", third_guess, "> for your second guess")

# round 4
fourth_guess = subsequentRounds(third_guess)
print("Please try <", fourth_guess, "> for your second guess")

# round 5
fifth_guess = subsequentRounds(fourth_guess)
print("Please try <", fifth_guess, "> for your second guess")

# round 6
sixth_guess = subsequentRounds(fifth_guess)
print("Please try <", sixth_guess, "> for your last guess")
